...
constexpr int REFLECTION_MAP_SIZE = 512;
...
void Scene::InitializeScene()
{
	...
	upperReflectionFBO = new FBO();
	upperReflectionFBO->CreateFBO(REFLECTION_MAP_SIZE, REFLECTION_MAP_SIZE);

	lowerReflectionFBO = new FBO();
	lowerReflectionFBO->CreateFBO(REFLECTION_MAP_SIZE, REFLECTION_MAP_SIZE);
	...
	room = new Object(RoomPolygons, roomId, brickColor, noSpec, 1, false, brickTexture, brickNormalMap);
	floor = new Object(FloorPolygons, floorId, floorColor, brightSpec, 10, false, floorTexture, floorNormalMap);
	floor->skyboxReflectionStrength = 0.1f;
